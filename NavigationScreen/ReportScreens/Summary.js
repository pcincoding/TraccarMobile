...
const Summary = ({navigation}) => {
  ...
  const tableHead =  ['Device', 'Start Date', 'Distance', 'Average Speed'];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        ...
        <Text style={{ fontSize: 20, marginLeft: 6 }}>Reports / Summary</Text>
      </View>
      {/* <DrawerNav /> */}
      ...
      <View style={styles.dropdownsContainer}>
        ...
        <View style={styles.dropdown}>
          <Picker selectedValue={selectType} onValueChange={(item) => setSelectType(item)} style={styles.devices}>
            <Picker.Item label='Nepali' value="nepali" />
          </Picker>
        </View>
        <View style={styles.dropdown}>
